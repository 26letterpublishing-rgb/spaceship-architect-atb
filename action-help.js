(function() {
  const descriptions = {
    ...
    evade:['Evasive Maneuvers','Roll Evade dice + Pilot/Helm + Hull Size Modifier. Use the higher of this result and Masking as Defense against the next attack only. Preparing another maneuver adds another one-attack defense.'],
