(function() {
  ...
  document.addEventListener('click',event=>{
    ...
    if(!host.querySelector('link[data-space-map-style]')) {
      const style=host.createElement('link');style.rel='stylesheet';style.href=new URL('space-map.css?v=20260908-thrusters-2',location.href).href;style.dataset.spaceMapStyle='';host.head.append(style);
    }
